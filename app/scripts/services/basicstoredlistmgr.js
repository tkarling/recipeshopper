    ...
    return {
      getSharedStoredListMgr: function (fbUrlWNoBase, fieldNameOrVariableUrl, fieldValue) {
        ...
        if (mgrItem == null) {
          ...
          $log.debug('getSharedStoredListMgr: getUsersStoredListMgr: newMgrItem', newMgrItem);
        ...
        // $log.debug('getSharedStoredListMgr: : getUsersStoredListMgr StoredListMgrs.length: ', StoredListMgrs.length );
        // $log.debug('getSharedStoredListMgr: getUsersStoredListMgr: mgrItem', mgrItem);
        // $log.debug('getSharedStoredListMgr: getUsersStoredListMgr: mgrItem.mgr', mgrItem.mgr);
        return mgrItem.mgr;
      }, // getSharedStoredListMgr

      getUsersStoredListMgr: function (fbUrlWNoBase, fieldNameOrVariableUrl, fieldValue) {
        var myUid = settingsMgr.getCurrentUser();
        var myFbUrlWNoBase = '/' + myUid + fbUrlWNoBase;
        //$log.debug('StoredListMgrFactory: getUsersStoredListMgr: myUid, myFbUrlWNoBase', myUid, myFbUrlWNoBase);
